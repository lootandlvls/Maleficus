...
public class IceBall : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.layer == 11)
        {
            ...
            if (other.gameObject.tag != shooterTag && other.gameObject.tag == "Player1" || reflected )
            {
            ...
            if (other.gameObject.tag != shooterTag && other.gameObject.tag == "Player2" || reflected)
            {
            ...
            if (other.gameObject.tag != shooterTag && other.gameObject.tag == "Player3" || reflected)
            {
            ...
            if (other.gameObject.tag != shooterTag && other.gameObject.tag == "Player4" || reflected)
            {
