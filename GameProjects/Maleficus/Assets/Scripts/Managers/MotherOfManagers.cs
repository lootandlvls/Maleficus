...
public class MotherOfManagers: AbstractSingletonManager<MotherOfManagers>
{
    ...
    [SerializeField] public bool IsAIClosestSpellDeviationEnabled = true;
    [SerializeField] public bool IsAIPushDeviationEnabled = true;


    [Separator("Spell")]
    [SerializeField] public bool IsLoadDebugSpells = false;
    [SerializeField] public bool IsLimitMaxPushPower = false;
    [SerializeField] public float spellPreviewScaleFactor = 1.0f;
